...
Dice.diceDefinitions = {
    /* cSpell:disable */
    WHITE: { sides: 'SSSHHM', color: '#ffffff', desc: 'Balanced basic dice' },
    BLUE: { sides: 'SSHHHM', color: '#ffffff', desc: 'Defense dice' },
    RED: { sides: 'SSSSHH', color: '#ffffff', desc: 'Offense dice' },
    GREEN: { sides: 'VBSMM ', color: '#ffffff', desc: 'Poison dice' },
    AQUA: { sides: 'FFSSMM', color: '#ffffff', desc: 'Speed dice' },
    YELLOW: { sides: 'MMSHH ', color: '#ffffff', desc: 'Morale dice' },
    PURPLE: { sides: 'BBHMMM', color: '#ffffff', desc: 'Knowledge dice' },
    /* cSpell:enable */
};
