...
const PhaserTimerEvent_js_1 = require("./PhaserTimerEvent.js");
const PhaserArrayRemove_js_1 = require("./PhaserArrayRemove.js");
/**
 * @classdesc
...
class Clock {
    ...
    addEvent(config) {
        var event;
        if (config instanceof PhaserTimerEvent_js_1.TimerEvent) {
            event = config;
            ...
            event = new PhaserTimerEvent_js_1.TimerEvent(config);
        }
    ...
    removeEvent(events) {
        ...
        for (var i = 0; i < events.length; i++) {
            var event = events[i];
            (0, PhaserArrayRemove_js_1.Remove)(this._pendingRemoval, event);
            (0, PhaserArrayRemove_js_1.Remove)(this._pendingInsertion, event);
            (0, PhaserArrayRemove_js_1.Remove)(this._active, event);
        }
        return this;
    }
    /**
...
exports.Clock = Clock;
//# sourceMappingURL=PhaserClock.js.map