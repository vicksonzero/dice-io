...
const PhaserUtils_1 = require("./PhaserUtils");
/**
 * @classdesc
...
class TimerEvent {
     ...
     */
    reset(config) {
        this.delay = (0, PhaserUtils_1.GetFastValue)(config, 'delay', 0);
        //  Can also be set to -1 for an infinite loop (same as setting loop: true)
        this.repeat = (0, PhaserUtils_1.GetFastValue)(config, 'repeat', 0);
        this.loop = (0, PhaserUtils_1.GetFastValue)(config, 'loop', false);
        this.callback = (0, PhaserUtils_1.GetFastValue)(config, 'callback', undefined);
        this.callbackScope = (0, PhaserUtils_1.GetFastValue)(config, 'callbackScope', this.callback);
        this.args = (0, PhaserUtils_1.GetFastValue)(config, 'args', []);
        this.timeScale = (0, PhaserUtils_1.GetFastValue)(config, 'timeScale', 1);
        this.startAt = (0, PhaserUtils_1.GetFastValue)(config, 'startAt', 0);
        this.paused = (0, PhaserUtils_1.GetFastValue)(config, 'paused', false);
...
//# sourceMappingURL=PhaserTimerEvent.js.map